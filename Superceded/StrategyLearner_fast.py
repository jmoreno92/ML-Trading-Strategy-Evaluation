...
class StrategyLearner(object):  		  	   		  	  		  		  		    	 		 		   		 		  
    ...
    def __init__(self, verbose=False, impact=0.0, commission=0.0):  		  	   		  	  		  		  		    	 		 		   		 		  
        ...
        self.Qlearner = ql.QLearner(num_states=1000,num_actions=3,alpha=0.2,gamma=0.9,
                                    rar=0.98,radr=0.99,dyna=0,verbose=False)  # initialize the learner
    ...
    def add_evidence(
        ...
        df_ind = pd.concat([price_EMA, bbp, roc], axis=1)    # Concatenate indicators in dataframe
        del price_EMA, bbp, roc, indicator  # Delete vectors, as they are now part of df_ind
...
def InSampleRun():
    ...
    # STRATEGY LEARNER
    # TODO: No verbose
    learner = StrategyLearner(verbose=True, commission=9.95, impact=0.005)     # constructor
