...
class indicators(object):
    ...
    def SMA(self,lookback):
        ...
        # # SLOW ALTERNATIVE: Extended price 'ext_price' DataFrame to account for trading days before start day equal to lookback
    ...
    def RSI(self,lookback):
        ...
        # Ignore previous days
        rsi = rsi.ix[lookback:,:]
        # Parameters not required for Project 8:
        # rs = rs.ix[lookback:, :]
    ...
    def FSO(self,lookback = 14):
        ...
        # Extended price 'ext_price' DataFrame to account for trading days before start day equal to lookback
        # This code can be optimized. See SMA indicator as an example.
        while prev_days < lookback:
